    ...
    return course ? (
        <Grid container display="inline">
            ...
            <Grid item sm={12} position="relative" height="16rem">
                <picture>
                    <Image src={course.imageUrl} alt={course.name} blurDataURL={course.imageUrl} layout="fill"
                        objectFit="cover"
                ...
                <Box position="relative" height="100%" alignItems="center" display="flex">
                    <CourseTitle>
                        <Typography fontWeight={600} variant="h2" color="white"> {course.name} </Typography>
                    </CourseTitle>
                </Box>
            </Grid>
        </Grid>
